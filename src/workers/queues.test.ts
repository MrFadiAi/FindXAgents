...
describe('queues.ts', () => {
  ...
  describe('QUEUE_NAMES constant', () => {
    ...
    it('should have keys matching their values in a consistent dashed-lowercase format', () => {
      // Validates that values follow dashed-lowercase (supports multi-word like email-scheduler)
